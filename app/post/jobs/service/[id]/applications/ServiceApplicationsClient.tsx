...
export default function ServiceApplicationsClient({ id, initialSelectedApplicationId = '' }: Props) {
  const router = useRouter()
  const selectedApplicationId = initialSelectedApplicationId.trim() || null
  ...
  return (
    <main className="min-h-screen bg-neutral-50">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        {!loading && applications.length === 0 && <p className="text-neutral-600">No inquiries yet.</p>}
