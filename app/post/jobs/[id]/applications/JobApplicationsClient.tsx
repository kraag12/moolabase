...
export default function JobApplicationsClient({ id, initialSelectedApplicationId = '' }: Props) {
  ...
  return (
    <main className="min-h-screen bg-neutral-50">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        {!loading && applications.length === 0 && <p className="text-neutral-600">No applications yet.</p>}
